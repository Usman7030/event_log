...
export declare type ReadRevision = typeof constants.START | typeof constants.END | bigint;
export declare type ReadPosition = typeof constants.START | typeof constants.END | Position;
/**
 ...
 */
export declare type ExpectedRevision = typeof constants.ANY
/**
 ...
 */
 | bigint;
export declare type AppendExpectedRevision = 
/**
 ...
 */
 | ExpectedRevision;
export declare type CurrentRevision = 
/**
 ...
 */
export declare type Direction = typeof constants.FORWARDS | typeof constants.BACKWARDS;
...
export declare type ConsumerStrategy = typeof constants.DISPATCH_TO_SINGLE | typeof constants.ROUND_ROBIN | typeof constants.PINNED;
export declare type PersistentAction = typeof constants.PARK | typeof constants.RETRY | typeof constants.SKIP | typeof constants.STOP;
export declare type NodePreference = typeof constants.RANDOM | typeof constants.FOLLOWER | typeof constants.LEADER | typeof constants.READ_ONLY_REPLICA;
...
export declare type VerifyOptions = Parameters<typeof ChannelCredentials.createSsl>[3];
export declare type GRPCClientConstructor<T extends GRPCClient> = new (address: string, credentials: ChannelCredentials, options?: Partial<GRPCClientOptions>) => T;
export declare type FilterOn = typeof constants.EVENT_TYPE | typeof constants.STREAM_NAME;
...
export declare type Filter = RegexFilter | PrefixesFilter;
...
export declare type PersistentSubscriptionToStream<E extends EventType = EventType> = PersistentSubscriptionBase<PersistentSubscriptionToStreamResolvedEvent<E>>;
export declare type PersistentSubscriptionToAll = PersistentSubscriptionBase<PersistentSubscriptionToAllResolvedEvent>;
export declare type StreamSubscription<E extends EventType = EventType> = ReadableSubscription<ResolvedEvent<E>>;
export declare type AllStreamSubscription = ReadableSubscription<AllStreamResolvedEvent>;
export { VNodeState };
export * from "./events";
